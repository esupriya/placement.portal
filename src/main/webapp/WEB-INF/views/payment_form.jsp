             ...
             <div class="input_group">
               ...
               <div class="heading">Qualification</div>
                 <select id="test" name="payment_method" class="name" onchange="showDiv('hidden_div', this)">
                    <option value="cod">B.E/B.Tech</option>
       ...
       <div class="input_group">
                ...
                <div class="heading">Department</div>
                     <select name="card_type" class="name">
                        <option value="visa">MCA</option>
                        <option value="rupay">M.com</option>
                      </select>
                </div>
            </div>
             <div class="input_group">
            ...
            <div class="input_group">
                <div class="input_box">
                <div class="heading">Reg.No</div>
                    <input type="text" name="cvv"  class="name">
                </div>
            </div>
            
            <div class="input_group">
                <div class="input_box">
                    <div class="heading">College Code</div>
                     <input type="text" name="card_no" placeholder="code" class="name">
                </div>
            </div>
            
            <div class="input_group">
                <div class="input_box">
                    <div class="heading">Year Of Passing</div>
...
function showDiv(divId, element)
{
    document.getElementById(divId).style.display = element.value == 1 ? 'block' : 'none';
                 ...
                 <div class="input_group">
                        <div class="input_box">
                            <button type="submit" onclick="fun()">Apply here! </button>
                        </div>
                    </div>
        </form>
    </div>
